...
part of 'text_field_initial_data.dart';
...
mixin _$TextFieldInitialData {
  ...
  $TextFieldInitialDataCopyWith<TextFieldInitialData> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TextFieldInitialDataCopyWith<$Res> {
  factory $TextFieldInitialDataCopyWith(TextFieldInitialData value,
          $Res Function(TextFieldInitialData) then) =
      _$TextFieldInitialDataCopyWithImpl<$Res, TextFieldInitialData>;
  @useResult
  $Res call(
      {String? label,
...
/// @nodoc
class _$TextFieldInitialDataCopyWithImpl<$Res,
        $Val extends TextFieldInitialData>
    implements $TextFieldInitialDataCopyWith<$Res> {
  _$TextFieldInitialDataCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$TextFieldInitialDataImplCopyWith<$Res>
    implements $TextFieldInitialDataCopyWith<$Res> {
  factory _$$TextFieldInitialDataImplCopyWith(_$TextFieldInitialDataImpl value,
          $Res Function(_$TextFieldInitialDataImpl) then) =
      __$$TextFieldInitialDataImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? label,
...
/// @nodoc
class __$$TextFieldInitialDataImplCopyWithImpl<$Res>
    extends _$TextFieldInitialDataCopyWithImpl<$Res, _$TextFieldInitialDataImpl>
    implements _$$TextFieldInitialDataImplCopyWith<$Res> {
  __$$TextFieldInitialDataImplCopyWithImpl(_$TextFieldInitialDataImpl _value,
      $Res Function(_$TextFieldInitialDataImpl) _then)
      : super(_value, _then);
...
class _$TextFieldInitialDataImpl implements _TextFieldInitialData {
  const _$TextFieldInitialDataImpl(
      {this.label = null,
  ...
  @override
  String toString() {
    return 'TextFieldInitialData(label: $label, helperMessage: $helperMessage, placeholder: $placeholder, maxCount: $maxCount, maxLine: $maxLine, inputType: $inputType, text: $text, focusState: $focusState, errorState: $errorState, state: $state, needToBlockOverflowInput: $needToBlockOverflowInput)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$TextFieldInitialDataImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$TextFieldInitialDataImplCopyWith<_$TextFieldInitialDataImpl>
      get copyWith =>
          __$$TextFieldInitialDataImplCopyWithImpl<_$TextFieldInitialDataImpl>(
              this, _$identity);
}

abstract class _TextFieldInitialData implements TextFieldInitialData {
  const factory _TextFieldInitialData(
      {final String? label,
      final String? helperMessage,
      final String? placeholder,
      final int? maxCount,
      ...
      final TextInputErrorState errorState,
      final TextInputState state,
      final bool needToBlockOverflowInput}) = _$TextFieldInitialDataImpl;
